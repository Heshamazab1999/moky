            ...
            builder: (context, profile, child) {
              return Row(children: [
                Padding(padding: const EdgeInsets.only(top: Dimensions.PADDING_SIZE_LARGE),
                  child: Image.asset(Images.logo_with_name_image_white, height: 35,color: Colors.white),
                ),
...
class TitleButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: Image.asset(image,color: Theme.of(context).primaryColor, width: 25, height: 25, fit: BoxFit.fill),
