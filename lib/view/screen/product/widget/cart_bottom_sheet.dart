          ...
          child: Consumer<ProductDetailsProvider>(
            builder: (ctx, details, child) {
              ...
              String _variantName = (widget.product.colors != null &&
                  widget.product.colors.length != 0) ? widget.product
                  .colors[details.variantIndex].name : null;
              ...
              double priceWithDiscount = PriceConverter.convertWithDiscount(
                  context, price, widget.product.discount,
              ...
              return Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                          double.parse(ratting).toStringAsFixed(
                                              1),
                                  ...
                                  SizedBox(height: widget.product.taxModel ==
                                      "include"
                ...
                (widget.product.colors != null &&
                    widget.product.colors.length > 0) ?
                widget.product.imageColors.isEmpty ? Row(children: [
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (ctx, index) {
                          String colorString = '0xff' +
                              widget.product.colors[index].code.substring(1, 7);
                          return InkWell(
                            onTap: () {
                              Provider.of<ProductDetailsProvider>(
                                  context, listen: false).setCartVariantIndex(
                                  widget.product.minimumOrderQty, index,
                                  context);
                            },
                            child: Container(
                              decoration: BoxDecoration(
                                  ...
                                  border: details.variantIndex == index ? Border
                                      .all(width: 1,
                                      color: Theme
                                          .of(context)
                                          .primaryColor) : null
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        itemCount:
                        widget.product.imageColors.length,
                        shrinkWrap: true,
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (ctx, index) {
                          String colorString = '0xff' +
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text(
                      getTranslated('total_price', context), style: robotoBold),
                ...
                Row(children: [
                  ...
                  Expanded(
                    child: CustomButton(buttonText: getTranslated(_stock <
                        widget.product.minimumOrderQty &&
                        widget.product.productType == "physical" ?
                    'out_of_stock' : 'add_to_cart', context),
                        onTap: _stock < widget.product.minimumOrderQty && widget
                            .product.productType == "physical" ? null : () {
                          if (_stock >= widget.product.minimumOrderQty ||
                            ...
                            CartModel cart = CartModel(
                                ...
                                Provider
                                    ...
                                    context, listen: false)
                                    .variationIndex,
                                widget.product.multiplyQty == 1 ? widget.product
                                    .shippingCost * details.quantity : widget
                  ...
                  Provider
                      ...
                      .addToCartLoading ? SizedBox() :
                  Expanded(
                    child: CustomButton(isBuy: true,
                        buttonText: getTranslated(_stock <
                            widget.product.minimumOrderQty &&
                            widget.product.productType == "physical"
                            ? 'out_of_stock'
                            : 'buy_now', context),
      ...
      onPressed: () {
        if (!isIncrement && quantity > 1) {
          if (quantity > minimumOrderQuantity) {
            ...
            Fluttertoast.showToast(
                msg: '${getTranslated(
                    'minimum_quantity_is', context)}$minimumOrderQuantity',
                toastLength: Toast.LENGTH_SHORT,
